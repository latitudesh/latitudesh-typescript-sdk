...
| `slug`                                                                             | *string*                                                                           | :heavy_minus_sign:                                                                 | The slug of the plan, used to create virtual machines                              |
...
| `availableOperatingSystems`                                                        | *string*[]                                                                         | :heavy_minus_sign:                                                                 | List of operating system slugs that are compatible with this plan                  |