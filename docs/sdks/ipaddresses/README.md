...
import { ipAddressesList } from "latitudesh-typescript-sdk/funcs/ipAddressesList.js";
...
async function run() {
  const res = await ipAddressesList(latitudesh, {});
  if (res.ok) {
    ...
    console.log("ipAddressesList failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="get-ip" method="get" path="/ips/{ip_id}" -->
```typescript
import { Latitudesh } from "latitudesh-typescript-sdk";
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { ipAddressesGet } from "latitudesh-typescript-sdk/funcs/ipAddressesGet.js";
...
async function run() {
  const res = await ipAddressesGet(latitudesh, {
    ipId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("ipAddressesGet failed:", res.error);
  }
}
...
**Promise\<[models.IpAddress](../../models/ipaddress.md)\>**
