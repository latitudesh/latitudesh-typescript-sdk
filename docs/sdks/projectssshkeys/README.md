...
import { projectsSshKeysPostProjectSshKey } from "latitudesh-typescript-sdk/funcs/projectsSshKeysPostProjectSshKey.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("projectsSshKeysPostProjectSshKey failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PostProjectSshKeyRequest](../../models/operations/postprojectsshkeyrequest.md)                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.PostProjectSshKeyResponse](../../models/operations/postprojectsshkeyresponse.md)\>**
