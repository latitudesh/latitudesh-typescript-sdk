...
<!-- UsageSnippet language="typescript" operationID="get-project" method="get" path="/projects/{project_id}" -->
```typescript
import { Latitudesh } from "latitudesh-typescript-sdk";
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { projectsGetProject } from "latitudesh-typescript-sdk/funcs/projectsGetProject.js";
...
async function run() {
  const res = await projectsGetProject(latitudesh, {
    projectId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
