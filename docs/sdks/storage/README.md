...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageListFilesystems } from "latitudesh-typescript-sdk/funcs/storageListFilesystems.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("storageListFilesystems failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageDeleteFilesystem } from "latitudesh-typescript-sdk/funcs/storageDeleteFilesystem.js";
...
async function run() {
  const res = await storageDeleteFilesystem(latitudesh, {
    filesystemId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("storageDeleteFilesystem failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageUpdateFilesystem } from "latitudesh-typescript-sdk/funcs/storageUpdateFilesystem.js";
...
async function run() {
  const res = await storageUpdateFilesystem(latitudesh, {
    filesystemId: "fs_7vYAZqGBdMQ94",
    requestBody: {
      data: {
        id: "fs_7vYAZqGBdMQ94",
  ...
  if (res.ok) {
    ...
    console.log("storageUpdateFilesystem failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageGetStorageVolumes } from "latitudesh-typescript-sdk/funcs/storageGetStorageVolumes.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("storageGetStorageVolumes failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageGetStorageVolume } from "latitudesh-typescript-sdk/funcs/storageGetStorageVolume.js";
...
async function run() {
  const res = await storageGetStorageVolume(latitudesh, {
    id: "vol_aKXgRdR3qv9k5",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("storageGetStorageVolume failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageDeleteStorageVolumes } from "latitudesh-typescript-sdk/funcs/storageDeleteStorageVolumes.js";
...
async function run() {
  const res = await storageDeleteStorageVolumes(latitudesh, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("storageDeleteStorageVolumes failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storagePostStorageVolumesMount } from "latitudesh-typescript-sdk/funcs/storagePostStorageVolumesMount.js";
...
async function run() {
  const res = await storagePostStorageVolumesMount(latitudesh, {
    id: "<id>",
    requestBody: {
      data: {
        type: "volumes",
  ...
  if (res.ok) {
    ...
    console.log("storagePostStorageVolumesMount failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageGetStorageObjects } from "latitudesh-typescript-sdk/funcs/storageGetStorageObjects.js";
...
async function run() {
  const res = await storageGetStorageObjects(latitudesh);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("storageGetStorageObjects failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storagePostStorageObjects } from "latitudesh-typescript-sdk/funcs/storagePostStorageObjects.js";
...
async function run() {
  const res = await storagePostStorageObjects(latitudesh, {
    data: {
      type: "objects",
      attributes: {
        project: "proj_6059EqYkOQj8p",
  ...
  if (res.ok) {
    ...
    console.log("storagePostStorageObjects failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageGetStorageObject } from "latitudesh-typescript-sdk/funcs/storageGetStorageObject.js";
...
async function run() {
  const res = await storageGetStorageObject(latitudesh, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("storageGetStorageObject failed:", res.error);
  }
}
...
```typescript
import { LatitudeshCore } from "latitudesh-typescript-sdk/core.js";
import { storageDeleteStorageObjects } from "latitudesh-typescript-sdk/funcs/storageDeleteStorageObjects.js";
...
async function run() {
  const res = await storageDeleteStorageObjects(latitudesh, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("storageDeleteStorageObjects failed:", res.error);
  }
}
