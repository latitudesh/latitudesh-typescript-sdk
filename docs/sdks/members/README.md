...
import { teamsMembersGetTeamMembers } from "latitudesh-typescript-sdk/funcs/teamsMembersGetTeamMembers.js";
...
async function run() {
  const res = await teamsMembersGetTeamMembers(latitudesh, {});
  if (res.ok) {
    ...
    console.log("teamsMembersGetTeamMembers failed:", res.error);
  }
}
