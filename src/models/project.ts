...
export namespace BillingType$ {
  /** @deprecated use `BillingType$inboundSchema` instead. */
  export const inboundSchema = BillingType$inboundSchema;
  /** @deprecated use `BillingType$outboundSchema` instead. */
  export const outboundSchema = BillingType$outboundSchema;
}
...
export namespace ProjectStats$ {
  /** @deprecated use `ProjectStats$inboundSchema` instead. */
  export const inboundSchema = ProjectStats$inboundSchema;
  /** @deprecated use `ProjectStats$outboundSchema` instead. */
  export const outboundSchema = ProjectStats$outboundSchema;
  /** @deprecated use `ProjectStats$Outbound` instead. */
  export type Outbound = ProjectStats$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ProjectBilling$ {
  /** @deprecated use `ProjectBilling$inboundSchema` instead. */
  export const inboundSchema = ProjectBilling$inboundSchema;
  /** @deprecated use `ProjectBilling$outboundSchema` instead. */
  export const outboundSchema = ProjectBilling$outboundSchema;
  /** @deprecated use `ProjectBilling$Outbound` instead. */
  export type Outbound = ProjectBilling$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ProjectAttributes$ {
  /** @deprecated use `ProjectAttributes$inboundSchema` instead. */
  export const inboundSchema = ProjectAttributes$inboundSchema;
  /** @deprecated use `ProjectAttributes$outboundSchema` instead. */
  export const outboundSchema = ProjectAttributes$outboundSchema;
  /** @deprecated use `ProjectAttributes$Outbound` instead. */
  export type Outbound = ProjectAttributes$Outbound;
}
