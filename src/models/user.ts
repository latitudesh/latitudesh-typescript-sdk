...
export namespace UserRole$ {
  ...
  /** @deprecated use `UserRole$Outbound` instead. */
  export type Outbound = UserRole$Outbound;
}
...
export namespace UserAttributes$ {
  /** @deprecated use `UserAttributes$inboundSchema` instead. */
  export const inboundSchema = UserAttributes$inboundSchema;
  /** @deprecated use `UserAttributes$outboundSchema` instead. */
  export const outboundSchema = UserAttributes$outboundSchema;
  /** @deprecated use `UserAttributes$Outbound` instead. */
  export type Outbound = UserAttributes$Outbound;
}
