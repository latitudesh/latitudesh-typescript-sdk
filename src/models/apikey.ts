 ...
 */
export namespace ApiKeyType$ {
  /** @deprecated use `ApiKeyType$inboundSchema` instead. */
  export const inboundSchema = ApiKeyType$inboundSchema;
  /** @deprecated use `ApiKeyType$outboundSchema` instead. */
  export const outboundSchema = ApiKeyType$outboundSchema;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ApiKeyUser$ {
  /** @deprecated use `ApiKeyUser$inboundSchema` instead. */
  export const inboundSchema = ApiKeyUser$inboundSchema;
  /** @deprecated use `ApiKeyUser$outboundSchema` instead. */
  export const outboundSchema = ApiKeyUser$outboundSchema;
  /** @deprecated use `ApiKeyUser$Outbound` instead. */
  export type Outbound = ApiKeyUser$Outbound;
}
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ApiKeyAttributes$ {
  /** @deprecated use `ApiKeyAttributes$inboundSchema` instead. */
  export const inboundSchema = ApiKeyAttributes$inboundSchema;
  /** @deprecated use `ApiKeyAttributes$outboundSchema` instead. */
  export const outboundSchema = ApiKeyAttributes$outboundSchema;
  /** @deprecated use `ApiKeyAttributes$Outbound` instead. */
  export type Outbound = ApiKeyAttributes$Outbound;
}
