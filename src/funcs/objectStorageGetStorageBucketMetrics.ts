...
export function objectStorageGetStorageBucketMetrics(
  ...
  Result<
    operations.GetStorageBucketMetricsResponse,
    | errors.ErrorObject
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetStorageBucketMetricsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/storage/buckets/{bucket_id}/metrics")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetStorageBucketMetricsResponse$inboundSchema, {
