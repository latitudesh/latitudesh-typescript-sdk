...
export function objectStorageGetStorageAccessKeys(
  ...
  Result<
    operations.GetStorageAccessKeysResponse,
    | errors.ErrorObject
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetStorageAccessKeysRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetStorageAccessKeysResponse$inboundSchema, {
