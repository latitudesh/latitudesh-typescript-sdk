...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ServerUnlockRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/servers/{server_id}/unlock")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Server$inboundSchema, {
