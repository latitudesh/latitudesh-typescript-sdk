...
export function objectStoragePostStorageBucketLifecycleRules(
  ...
  Result<
    operations.PostStorageBucketLifecycleRulesResponse,
    | errors.ErrorObject
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostStorageBucketLifecycleRulesRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      201,
      operations.PostStorageBucketLifecycleRulesResponse$inboundSchema,
