 ...
 */
export function objectStoragePostStorageObjects(
  client: LatitudeshCore,
  request: operations.PostStorageObjectsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostStorageObjectsResponse,
    | errors.ErrorObject
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostStorageObjectsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostStorageObjectsResponse$inboundSchema, {
