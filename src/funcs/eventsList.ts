...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetEventsRequest$outboundSchema.optional().parse(value),
  ...
  const query = encodeFormQuery({
    "filter[action]": payload?.["filter[action]"],
    "filter[author]": payload?.["filter[author]"],
    "filter[created_at]": payload?.["filter[created_at]"],
    "filter[created_at][gte]": payload?.["filter[created_at][gte]"],
    "filter[created_at][lte]": payload?.["filter[created_at][lte]"],
    "filter[project]": payload?.["filter[project]"],
    "filter[target_id]": payload?.["filter[target_id]"],
