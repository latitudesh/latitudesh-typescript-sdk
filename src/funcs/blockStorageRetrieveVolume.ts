...
export function blockStorageRetrieveVolume(
  ...
  Result<
    operations.RetrieveVolumeResponse,
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RetrieveVolumeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RetrieveVolumeResponse$inboundSchema, {
