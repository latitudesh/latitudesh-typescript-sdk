...
export function projectsSshKeysPostProjectSshKey(
  ...
  Result<
    operations.PostProjectSshKeyResponse,
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostProjectSshKeyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostProjectSshKeyResponse$inboundSchema, {
