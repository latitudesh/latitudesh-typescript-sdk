...
export function vpnSessionsList(
  ...
  Result<
    operations.GetVpnSessionsResponse,
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetVpnSessionsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetVpnSessionsResponse$inboundSchema, {
