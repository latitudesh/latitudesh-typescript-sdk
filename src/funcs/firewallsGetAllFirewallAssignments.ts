...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllFirewallAssignmentsRequest$outboundSchema.optional()
        .parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllFirewallAssignmentsResponse$inboundSchema, {
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      firewallsGetAllFirewallAssignments(
        client,
        {
          ...request,
          pageNumber: nextPage,
