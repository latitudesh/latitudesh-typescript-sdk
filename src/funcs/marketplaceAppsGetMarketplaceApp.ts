...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMarketplaceAppRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/marketplace_apps/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.MarketplaceApp$inboundSchema, {
