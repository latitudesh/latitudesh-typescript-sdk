...
export function teamsUpdate(
  ...
  Result<
    operations.PatchCurrentTeamResponse,
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchCurrentTeamRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/team/{team_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchCurrentTeamResponse$inboundSchema, {
