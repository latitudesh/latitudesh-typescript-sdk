...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateVirtualMachineNetworkAttachmentRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      202,
      operations.CreateVirtualMachineNetworkAttachmentResponse$inboundSchema,
      { ctype: "application/vnd.api+json" },
    ),
    M.fail([403, 404, 422, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
