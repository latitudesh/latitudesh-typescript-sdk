...
export function storagePostStorageVolumes(
  ...
  Result<
    operations.PostStorageVolumesResponse,
    | errors.ErrorObject
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostStorageVolumesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostStorageVolumesResponse$inboundSchema, {
