...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetFirewallAssignmentsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFirewallAssignmentsResponse$inboundSchema, {
