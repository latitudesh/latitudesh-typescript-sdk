...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateFirewallRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/firewalls/{firewall_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Firewall$inboundSchema, {
