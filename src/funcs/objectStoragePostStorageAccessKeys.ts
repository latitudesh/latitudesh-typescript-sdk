...
export function objectStoragePostStorageAccessKeys(
  ...
  Result<
    operations.PostStorageAccessKeysResponse,
    | errors.ErrorObject
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostStorageAccessKeysRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostStorageAccessKeysResponse$inboundSchema, {
