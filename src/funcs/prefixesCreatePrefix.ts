 ...
 */
export function prefixesCreatePrefix(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreatePrefix$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.Prefix$inboundSchema, {
      ctype: "application/vnd.api+json",
    }),
    M.jsonErr([403, 409, 422], errors.ErrorObject$inboundSchema, {
      ctype: "application/vnd.api+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
