...
export function blockStorageCreateVolume(
  ...
  Result<
    operations.CreateVolumeResponse,
    | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateVolumeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateVolumeResponse$inboundSchema, {
