...
export function operatingSystemsListPlans(
  ...
  PageIterator<
    Result<
      operations.GetPlansOperatingSystemResponse,
      | LatitudeshError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPlansOperatingSystemRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPlansOperatingSystemResponse$inboundSchema, {
