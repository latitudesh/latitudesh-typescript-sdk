...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetVirtualNetworksAssignmentsRequest$outboundSchema.optional()
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.GetVirtualNetworksAssignmentsResponse$inboundSchema,
      { ctype: "application/vnd.api+json", key: "Result" },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
