...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateIpmiSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/servers/{server_id}/remote_access")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.IpmiSession$inboundSchema, {
