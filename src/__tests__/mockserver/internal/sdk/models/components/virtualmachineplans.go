...
// TypeLocal - The type of the disk
...
type Disk struct {
	...
	Type *TypeLocal `json:"type,omitempty"`
	Size *Size      `json:"size,omitempty"`
}

func (o *Disk) GetType() *TypeLocal {
	if o == nil {
		return nil
	}
	return o.Type
...
type VirtualMachinePlansRegion struct {
	Name      *string                     `json:"name,omitempty"`
	Available []string                    `json:"available,omitempty"`
	Pricing   *VirtualMachinePlansPricing `json:"pricing,omitempty"`
}

func (o *VirtualMachinePlansRegion) GetName() *string {
	if o == nil {
		return nil
	}
	return o.Name
...
func (o *VirtualMachinePlansRegion) GetAvailable() []string {
	if o == nil {
		return nil
	}
	return o.Available
...
func (o *VirtualMachinePlansRegion) GetPricing() *VirtualMachinePlansPricing {
	if o == nil {
		return nil
	}
	return o.Pricing
...
type VirtualMachinePlansAttributes struct {
	...
	Regions []VirtualMachinePlansRegion `json:"regions,omitempty"`
...
func (o *VirtualMachinePlansAttributes) GetRegions() []VirtualMachinePlansRegion {
	if o == nil {
		return nil
	}
	return o.Regions
